...
export const isTraveler = ( object ) => {
    ...
    function travelTo( finalPosition, time, parameters ) {
        ...
        const _easing = parameters && parameters.easing ? parameters.easing : TWEEN.Easing.Linear.None;
    ...
    function lookAt( target, time, parameters ) {
        ...
        const _finalPosition = parameters && parameters.finalPosition ? parameters.finalPosition : _object.position.clone();
        ...
        _object.position.set( _initialPosition.x, _initialPosition.y, _initialPosition.z );
