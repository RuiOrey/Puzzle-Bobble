            ...
            if ( material )
              {
                ...
                _border.left.mesh = new THREE.Mesh( borderSideGeometry,
                    material );
                _border.right.mesh = new THREE.Mesh( borderSideGeometry,
                    material );
                _border.top.mesh = new THREE.Mesh( borderTopGeometry,
                    material );
